...
oceans_eleven = media.Movie("Ocean's Eleven",
                            ...
                            "https://thedinglehopper.files.wordpress.com/2014/08/oe01.jpeg",  # noqa
...
out_of_time = media.Movie("Out of Time",
                          ...
                          before he himself falls under suspicion.",
                          "https://upload.wikimedia.org/wikipedia/en/thumb/3/3a/Out_of_timeposter.jpg/220px-Out_of_timeposter.jpg",  # noqa
                          "https://www.youtube.com/watch?v=I3GeAu_b05I",)

oceans_twelve = media.Movie("Ocean's Twelve",
                            "Danny Ocean (George Clooney) and his crew\
                            of thieves have big problems. ",
                            "https://www.imfdb.org/images/d/d9/O12-dvd.jpg",
                            "https://www.youtube.com/watch?v=k5CZa3X4yF4",)

deja_vu = media.Movie("Deva Vu",
                      "The team of top-secret program brings\
                      ATF agent Doug Carlin (Denzel Washington)\
                      into its midst to capture the terrorist (Jim Caviezel)\
                      responsible for a ferry bombing\
                      that left hundreds dead.",
                      "https://images-na.ssl-images-amazon.com/images/I/51IJG6YR1-L.jpg",  # noqa
                      "https://www.youtube.com/watch?v=uxdS8TP37I4",)

split = media.Movie("Split",
                    "Three girls are kidnapped by a man\
                    with a diagnosed 23 distinct personalities",
                    "https://images-na.ssl-images-amazon.com/images/M/MV5BZGM5NzI4YWEtNzlkYS00NWM1LTg4ZjctMDQ5ZmNlYTY0NjNmL2ltYWdlL2ltYWdlXkEyXkFqcGdeQXVyMjY5ODI4NDk@._V1_SY1000_CR0,0,675,1000_AL_.jpg",  # noqa
                    "https://www.youtube.com/watch?v=84TouqfIsiI",)

blow = media.Movie("Blow",
                   "The story of George Jung, the man\
                   who established the American cocaine market",
